...
// swiftlint:disable:next body_length type_body_length file_length
public enum LocalizedType: String, CaseIterable, Identifiable, LocalizableString {
	...
	/// ビルド番号
	case CommonBuildNumber
	/// iOSバージョン
	case CommoniOsVersion
